...
Settings load_settings(const std::filesystem::path& ini_path) {
    ...
    s.gpu_power_boost_enabled = get_b(ini, "efficiency", "gpu_power_boost_enabled", false);
    ...
    s.gpu_difficulty_power_enabled = get_b(ini, "efficiency", "gpu_difficulty_power_enabled", false);
